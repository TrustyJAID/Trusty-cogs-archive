...
class Unity4J:
    ...
    async def unity4jroles(self, ctx):
        ...
        if guild.id not in [469771424274317312, 321105104931389440]:
            return
        em = discord.Embed()
        em.description = "Type only the command after the role to be assigned that role:\n<#473247189401862154> <@&469906844157214721> `;analytics`\n<#473247187732529163> <@&470398819763355659> `;blogger`\n<#473247188496154635> <@&471145950522376202> `;design`\n<#473247187732529163> <@&469805682204606464> `;facebooker`\n<#473234759254802432> <@&473220172958793760> `;faith`\n<#473247189401862154> <@&470735200540688394> `;gabber`\n<#473247189401862154> <@&470724785480007680> `;google`\n<#473247189401862154> <@&469809793947795466> `;graphics`\n<#473247189401862154> <@&470397209733496863> `;instagrammer`\n<#473247187732529163> <@&471107903777144852> `;legal`\n<#473247187732529163> <@&471146076573925377> `;minds`\n<#469807830250160128> <@&469809734141345793> `;music`\n<#469808195905519642> <@&470393412688805888> `;podcaster`\n<#471009013564440576> <@&471062064010493953> `;proofreader`\n<#473247188496154635> <@&469806187462787074> `;redditor`\n<#473247188496154635> <@&470390853492408340> `;researcher`\n<#473247187732529163> <@&469885340006613003> `;scribe`\n<#469825488664395788> <@&469825196681854978> `;translator`\n<#473247187732529163> <@&469806854881673227> `;steemian`\n<#473250263507927041> <@&471232671784239104> `;streamteam`\n<#473247187732529163> <@&472987153857642496> `;truth`\n<#470638042428997643> <@&470638081909850113> `;tumblr`\n<#469782554682064905> <@&469806127832629259> `;tweeter`\n<#473247188496154635> <@&469809330489655296> `;video`\n<#470549754145800200> <@&469809460962000896> `;webteam`\n<#473247188496154635> <@&470390921293463582> `;youtuber`"
