...
class Unity4J:
    ...
    async def unity4jroles(self, ctx):
        ...
        if guild.id not in [469771424274317312, 321105104931389440]:
            return
        em = discord.Embed()
        em.description = "Type only the command after the role to be assigned that role:\n<@&469906844157214721> `;analytics`\n<@&470398819763355659> `;blogger`\n<@&471145950522376202> `;design`\n<@&469805682204606464> `;facebooker`\n<@&470735200540688394> `;gabber`\n<@&470724785480007680> `;google`\n<@&469809793947795466> `;graphics`\n<@&470397209733496863> `;instagrammer`\n<@&471107903777144852> `;legal`\n<@&471146076573925377> `;minds`\n<@&469809734141345793> `;music`\n<@&470393412688805888> `;podcaster`\n<@&471062064010493953> `;proofreader`\n<@&469806187462787074> `;redditor`\n<@&470390853492408340> `;researcher`\n<@&469885340006613003> `;scribe`\n<@&469825196681854978> `;translator`\n<@&469806854881673227> `;steemian`\n<@&471232671784239104> `;streamteam`\n<@&469825196681854978> `;translator`\n<@&472987153857642496> `;truth`\n<@&470638081909850113> `;tumblr`\n<@&469806127832629259> `;tweeter`\n<@&469809330489655296> `;video`\n<@&469809460962000896> `;webteam`\n<@&470390921293463582> `;youtuber`"
